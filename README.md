# Hi, I'm AritzElge
### Industrial Electronics & Automation Engineer | Deterministic Embedded Systems & System Architecture | Formal Modeling, FDIR & Safety-Critical Design

I design and build solutions where **determinism**, **safety**, and **reliability** are non-negotiable. I specialize in transforming complex system requirements into explicit, traceable and verifiable architectures, ensuring that implementation remains deterministic and predictable throughout the full development lifecycle. My engineering approach bridges the gap between robust analog physics and high-performance digital logic, working natively in Linux/POSIX environments for mission-critical applications.
...
A research-oriented deterministic execution framework focused on formal modeling, hardware abstraction and predictable execution for mission-critical control systems.
...
- Formal Modeling (SFC/FSM)
- FMEA & FDIR Analysis
- WCET-Driven Development
- Hardware-Agnostic Architecture

## Engineering Philosophy

- Design is the source of truth; implementation is its consequence.
- Explicit models are preferred over implicit behavior.
- Every engineering decision should be traceable and justifiable.
- Determinism is designed, not assumed.
- Failure modes must be understood before they occur.

## Technical Stack & Expertise

- **Safety-Critical:** MISRA-C compliance, NASA software standards, Hard Real-Time determinism.
- **Microcontrollers/SoC:** STM32 (including **STM32MP1** Dual-Core), ESP32-C3, Intel Galileo, AVR, PIC, Renesas.
